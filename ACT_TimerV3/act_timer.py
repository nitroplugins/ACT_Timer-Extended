...
sections = [
    {"name": "English", "time": 70, "questions": 75, "seconds_per_question": 70 * 60 / 75},
    {"name": "Math", "time": 90, "questions": 60},
    {"name": "Break", "time": 15, "questions": None},
    {"name": "Reading", "time": 55, "questions": 40, "seconds_per_question": 55 * 60 / 40},
    {"name": "Science", "time": 55, "questions": 40, "seconds_per_question": 55 * 60 / 40},
]

class ACTTimerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("ACT Extended Time Timer")
